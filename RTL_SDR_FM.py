...
class RTL_SDR_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "RTL Receiver FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL Receiver FM")
        ...
        self._rfGanho_range = qtgui.Range(0, 50, 1, 10, 200)
        self._rfGanho_win = qtgui.RangeWidget(self._rfGanho_range, self.set_rfGanho, "RF Ganho (db)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._rfGanho_win, 1, 0, 1, 10)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_range = qtgui.Range(87.7e6, 107.9e6, 200e3, 88.5e6, 200)
        ...
        self._soapy_rtlsdr_source_0_gain_value = rfGanho
        self.set_soapy_rtlsdr_source_0_gain_mode(0, bool(False))
        self.set_soapy_rtlsdr_source_0_gain(0, 'TUNER', rfGanho)
    ...
    def get_rfGanho(self):
        return self.rfGanho

    def set_rfGanho(self, rfGanho):
        self.rfGanho = rfGanho
        self.set_soapy_rtlsdr_source_0_gain(0, 'TUNER', self.rfGanho)
